 ...
 * 
 * Self-contained pipeline infrastructure for the review-trust-domain domain:
...
export interface ReviewTrustDomainPipelineStackProps extends cdk.StackProps {
  domain: string;
...
export class ReviewTrustDomainPipelineStack extends cdk.Stack {
  public readonly artifactBucket: s3.Bucket;

  constructor(scope: Construct, id: string, props: ReviewTrustDomainPipelineStackProps) {
